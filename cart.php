...
<head>
    ...
    <title>Contigo Appaerl. Co website Cart Details</title>
<!-- bootstrap CSS link -->
...
<div class="container">
    ...
    while($row= mysqli_fetch_array($result)){
        ...
        ?>
                ...
                <td><img src="./images/<?php echo $product_image1 ?>" alt="<?php echo $product_title ?>" class="card-img"></td>
    ...
    if  (isset($_POST['update_cart'])){
        ...
        $total = total_cart_price() * $quantities;
    }
                ?>
                ...
                <td>
                    ...
                    <input type="submit" value="Remove Cart Item" class="bg-info px-3 py-2 border-0 mx-3" name="remove_cart">
                </td>
            </tr>
            <?php }
    } ?>
    ...
    <div class='d-flex mb-3'>
        ...
        <a href="index.php"><button class='btn btn-secondary px-3 mx-2' >Continue shopping</button></a>
        <button class='btn btn-secondary px-3'><a href="./users_area/checkout.php" class='text-light text-decoration-none'>Checkout</a></button>
